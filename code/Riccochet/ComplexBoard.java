...
public class ComplexBoard extends JFrame implements ActionListener
{
    ...
    public ComplexGrid [][] gridSquares;  // squares to appear in grid formation in the bottom panel
    ...
    public ComplexBoard(int x, int y, boolean Load)
    {
        ...
        for ( int column = 0; column < x; column ++)
        {
            for ( int row = 0; row < y; row ++)
            {
                ...
                gridSquares [column][row].setColor( column , row, redX, redY, blueX, blueY,  greenX,  greenY,  yellowX, yellowY);
                    ...
                    {   
                        if(column != selectedY & row!= selectedX){
                            ...
                            if(column==0){
                                ...
                                if(selectedX>10){
                                gridSquares[selectedY][checkRob(selectedX, 11, 1, column,1)].move(identifier);
                                ...
                                if(selectedX>7){
                                gridSquares[selectedY][checkRob(selectedX, 8, 1, column,1)].move(identifier);
                                ...
                                changeRob(checkRob(selectedX, 4, 1, column,1), selectedY);}
                                    ...
                                    else if(selectedX >9 & identifier==4 & checkRob(selectedX, 9, 1, column,1)==9){
                                ...
                                if(selectedX>11 & identifier == 2 & checkRob(selectedX, 11, 1, column,1)==11){                                                                    
                                        reflect(selectedX, column, 0, 1, 11);
                                    }
                                 else if(selectedX>5){
                        ...
                        if(column == selectedY & row> selectedX ){
                            ...
                            if(column==0){
                                ...
                                if(selectedX==0){
                                gridSquares[selectedY][checkRob(selectedX, 0, 1, column,2)].move(identifier);
                                ...
                                if(selectedX<11 & selectedX>1){
                                gridSquares[selectedY][checkRob(selectedX, 10, 1, column,2)].move(identifier);
                                ...
                                if(selectedX<8 ){
                                gridSquares[selectedY][checkRob(selectedX, 7, 1, column,2)].move(identifier);
                                ...
                                gridSquares[selectedY][checkRob(selectedX, 15, 1, column,2)].move(identifier);
                                changeRob(checkRob(selectedX, 15, 1, column,2), selectedY);}
                                else if(identifier==3 & checkRob(selectedX, 6, 1, column,1)==6 & selectedX<6){
                        ...
                        if(row == selectedX & column> selectedY){
                            ...
                            if(row==0){
                                ...
                                if(selectedY <14){
                                    if(selectedY < 7 &identifier==1 & checkRob(selectedY, 7, 2, row,2)==7){
                                        reflect(selectedY, row, 1, 2, 7);
                                    }
    ...
    private void GameLoad(boolean Load){
        ...
        if(Load){
            ...
            load.Loading();
             ...
             greenX = 13; greenY = 5; //Starting coords for the different robots
             blueX = 0; blueY = 0;
             yellowX = 10; yellowY = 3;
             redX = 3; redY = 11;
        }
