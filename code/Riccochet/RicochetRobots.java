...
public class RicochetRobots extends JFrame {
    ...
    private enum StateEnum {MenuState, GameState}
    ...
    //Sets menu type screen. It is static method so we can access from anywhere without creating instance.
    public static void SetUpScreen(JFrame frame, GridLayout grid, JPanel panel, JLabel label1
    , String LabelText, int fontsize)
