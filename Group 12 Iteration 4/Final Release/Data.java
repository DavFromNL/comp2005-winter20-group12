...
public class Data {
    ...
    private static Color[] blueOrangePalette = { new Color(220, 202, 152), new Color(255, 148, 0),
            new Color(225, 115, 38), new Color(173, 61, 111), new Color(147, 33, 146), new Color(147, 33, 145),
            Color.BLACK };
